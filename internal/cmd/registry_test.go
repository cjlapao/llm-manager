...
func TestRegistry_Basic(t *testing.T) {
	...
	expected := []string{"model", "container", "service", "hotspot", "logs", "mem", "update", "comfyui", "embed", "rerank", "rag", "speech", "import", "engine", "export", "compose", "swap", "litellm", "install", "uninstall", "generate"}
